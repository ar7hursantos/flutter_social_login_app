...
/// be selected. The values are of type `T`, the first type
/// parameter of the [CustomRadio]
/// class. Enums are commonly used for this purpose.
///
/// Animation values are of type `U`, the second type parameter of the
/// [CustomRadio] class,
/// this allows for stronger typing if only one type of animation is required.
/// This can be set to `dynamic` if more than one type of animation is required.
class CustomRadio<T, U> extends StatefulWidget {
  ...
  /// Returns the list of child animations whose values will be passed to the
  /// builder.
  /// Called on initState.
  ...
  /// states with no animation and the [animValues] passed to [builder] will
  /// be a list with the only element being whether the widget is checked or
  /// not.
